// @darkly/site-sheets — Waffle grid mutation observer
// MutationObserver that watches for toolbar rebuilds (happens on sheet switch,
 ...
 */
export function startGridObserver(onToolbarRemoved: () => void): () => void {
