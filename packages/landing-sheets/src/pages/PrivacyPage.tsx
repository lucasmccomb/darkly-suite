      ...
      <section className="privacy">
        <div className="container">
          ...
          <div className="privacy-content">
            <h2>Overview</h2>
            <p>
              Darkly for Google Sheets (&ldquo;Darkly&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;) is a Chrome extension that applies a dark mode
            ...
            <ul>
              ...
              <li><strong>Host access (docs.google.com/spreadsheets)</strong> — to inject the dark mode styles into Google Sheets</li>
            </ul>
            ...
            <p>
              ...
              at <a href="mailto:admin@sheetsdarkly.com">admin@sheetsdarkly.com</a>.
            </p>
          </div>
        </div>
      </section>
