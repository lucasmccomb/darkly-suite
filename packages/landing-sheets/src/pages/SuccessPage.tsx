...
import { Check, Table2, Download, ArrowRight, RefreshCw } from 'lucide-react'
      ...
      <section style={{
        ...
        <div style={{ textAlign: 'center', maxWidth: 520 }}>
          ...
          <p style={{
            ...
            {isRestored
              ? <>Your <Wordmark /> for Sheets license has been restored. Return to Google Sheets to continue using dark mode.</>
              : <>Welcome to <Wordmark /> for Sheets! You now have full access to intelligent dark mode for Google Sheets.</>}
          </p>

          {/* Return to Google Sheets button */}
          <a
          ...
          >
            ...
            <span className="btn-label">Return to Google Sheets</span>
          </a>
        </div>
      </section>
