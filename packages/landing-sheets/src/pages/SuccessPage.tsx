import { Check, Table2, Download, ArrowRight } from 'lucide-react'
      ...
      <section style={{
        ...
        <div style={{ textAlign: 'center', maxWidth: 520 }}>
          ...
          <p style={{
            ...
            Welcome to <Wordmark /> for Sheets! You now have full access to
            intelligent dark mode for Google Sheets.
          </p>
