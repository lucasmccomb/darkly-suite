    ...
    <>
      ...
      <section className="privacy">
        <div className="container">
          ...
          <p className="privacy-updated">Last updated: February 18, 2026</p>

          <div className="privacy-content">
            <h2>Overview</h2>
            <p>
              Darkly for Gmail (&ldquo;Darkly&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;) is a Chrome extension that applies a dark mode
              theme to Gmail. We are committed to protecting your privacy.
            </p>
            <p>
            ...
            <ul>
              <li>No email content is read, accessed, or stored</li>
            ...
            <p>Darkly requests the following Chrome permissions:</p>
            <ul>
              ...
              <li><strong>scripting</strong> — to apply the dark theme to Gmail</li>
              <li><strong>Host access (mail.google.com)</strong> — to inject the dark mode styles into Gmail</li>
            </ul>
            ...
            <p>
              ...
              at <a href="mailto:admin@gmaildarkly.com">admin@gmaildarkly.com</a>.
            </p>
          </div>
        </div>
      </section>
