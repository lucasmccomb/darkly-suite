...
import { Check, Mail, Download, ArrowRight, RefreshCw } from 'lucide-react'
...
export function SuccessPage() {
  ...
  return (
    <>
      ...
      <section style={{
        ...
        <div style={{ textAlign: 'center', maxWidth: 520 }}>
          ...
          <p style={{
            ...
            {isRestored
              ? <>Your <Wordmark /> for Gmail license has been restored. Return to Gmail to continue using dark mode.</>
              : <>Welcome to <Wordmark /> for Gmail! You now have full access to intelligent dark mode for Gmail.</>}
          </p>

          {/* Return to Gmail button */}
          <a
      ...
      {/* Continue Setup section — hide for restore flow (extension already installed) */}
      {!isRestored && (
