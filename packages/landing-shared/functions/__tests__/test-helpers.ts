...
export function createMockEnv(overrides: Partial<Env> = {}): Env {
  return {
    ...
    STRIPE_PRICE_BROWSE_MONTHLY: 'price_browse_monthly',
    STRIPE_PRICE_BROWSE_YEARLY: 'price_browse_yearly',
    STRIPE_PRICE_BROWSE_LIFETIME: 'price_browse_lifetime',
    ...
    STRIPE_PRODUCT_BROWSE: 'prod_test_browse',
