...
export const BROWSE_FAQ = [
  ...
  },
  {
    ...
    answer: "Yes. Browse Darkly works anywhere Chrome Desktop is installed. Your settings automatically sync across every Chrome browser where you're signed into the same Google account.",
  },
  {
