      ...
      <section className="privacy">
        <div className="container">
          ...
          <div className="privacy-content">
            ...
            <p>
              <strong>The short version:</strong> Browse Darkly stores your settings locally on your device.
            ...
            <p>
              Browse Darkly does not use analytics, tracking pixels, or advertising identifiers. The one
