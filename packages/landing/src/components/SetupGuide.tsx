...
export function SetupGuide({ activeTab }: SetupGuideProps) {
  ...
  return (
    <div className="setup-guide">
      ...
      <div className="setup-content">
        {tab === 'gmail' && <GmailGuide />}
        {tab === 'sheets' && <SheetsGuide />}
        {tab === 'docs' && <DocsGuide />}
      </div>
    </div>
  )
    ...
    <div className="setup-steps">
      <Step number={1} title="Install the extension">
        <p>
          ...
          <a href={STORE_URLS.gmail} target="_blank" rel="noopener noreferrer">
            Chrome Web Store
          </a>
    ...
    <div className="setup-steps">
      <Step number={1} title="Install the extension">
        <p>
          ...
          <a href={STORE_URLS.sheets} target="_blank" rel="noopener noreferrer">
            Chrome Web Store
          </a>
    ...
    <div className="setup-steps">
      <Step number={1} title="Install the extension">
        <p>
          ...
          <a href={STORE_URLS.docs} target="_blank" rel="noopener noreferrer">
            Chrome Web Store
          </a>
