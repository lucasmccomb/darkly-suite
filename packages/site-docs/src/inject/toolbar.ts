// @darkly/site-docs — Docs toolbar button injector
// Custom DOM injection for Google Docs toolbar.
// Waits for the toolbar to appear, then injects a Darkly brand icon
// styled to match Docs' native toolbar buttons.
...
/**
 * Create the toolbar button element styled to blend with Docs' toolbar.
 */
