    ...
    <>
      ...
      <section className="privacy">
        <div className="container">
          ...
          <p className="privacy-updated">Last updated: February 21, 2026</p>

          <div className="privacy-content">
            <h2>Overview</h2>
            <p>
              Darkly for Google Docs (&ldquo;Darkly&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;) is a Chrome extension that applies a dark mode
              theme to Google Docs. We are committed to protecting your privacy.
            </p>
            <p>
            ...
            <ul>
              <li>No document content is read, accessed, or stored</li>
            ...
            <ul>
              ...
              <li><strong>Host access (docs.google.com/document)</strong> — to inject the dark mode styles into Google Docs</li>
            </ul>
            ...
            <p>
              ...
              at <a href="mailto:admin@docsdarkly.com">admin@docsdarkly.com</a>.
            </p>
          </div>
        </div>
      </section>
